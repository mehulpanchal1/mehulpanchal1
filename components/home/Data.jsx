  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        A full stack developer with a side of AI enthusiasm.I relish in building
        robust web applications from front-end to back-end. Explore my work and
        join me on this exciting journey where technology evolves. View Resume
      </p>
